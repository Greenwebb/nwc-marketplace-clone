...
export default function DailyDeals() {
  ...
  return (
    <div className="relative overflow-hidden rounded-sm bg-gradient-to-br from-[#D8125D] to-[#FF6B6B] p-6 md:p-8">
      {/* Decorative circles */}
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-1 mb-4">
          <div className="bg-white rounded-sm px-2 py-1">
            <span className="text-lg font-bold text-[#1D2128]">{formatTime(timeLeft.hours)}</span>
          </div>
          <span className="text-white font-bold">:</span>
          <div className="bg-white rounded-sm px-2 py-1">
            <span className="text-lg font-bold text-[#1D2128]">{formatTime(timeLeft.minutes)}</span>
          </div>
          <span className="text-white font-bold">:</span>
          <div className="bg-white rounded-sm px-2 py-1">
            <span className="text-lg font-bold text-[#1D2128]">{formatTime(timeLeft.seconds)}</span>
          </div>
        </div>
        ...
        <Link href="/shop?sale=true">
          <a className="inline-flex items-center justify-center h-[46px] px-6 bg-white text-[#D8125D] text-sm font-medium rounded-sm hover:bg-white/90 transition-colors">
            Shop Now
          </a>
        </Link>
      </div>
