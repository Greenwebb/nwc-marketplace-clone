    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <Link href="/">
            <a className="text-xl font-bold text-[#11248F]">Motta Vendor</a>
          </Link>
          <button
            onClick={() => setSidebarOpen(false)}
              ...
              <Link key={item.name} href={item.href}>
                <a
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                    isActive
                      ? "bg-[#11248F] text-white shadow-md"
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-100 transition-all"
            onClick={() => {
          ...
          <div className="flex items-center justify-between h-full px-4 lg:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3 pl-3 border-l border-gray-200">
                ...
                <div className="w-10 h-10 rounded-full bg-[#11248F] flex items-center justify-center text-white font-semibold">
                  {user?.name?.[0] || "V"}
                </div>
              </div>
            </div>
