...
export default function VendorOnboarding() {
  ...
  const eBayInput = ({ label, helper, error, ...props }: any) => (
    <div className="space-y-1.5">
      ...
      <Input 
        className="rounded-lg border-gray-300 focus:border-black focus:ring-0 transition-all h-11" 
        {...props} 
      />
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Textarea 
            ...
            className="min-h-[180px] rounded-lg border-gray-300 focus:border-black focus:ring-0"
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input 
              type="number" 
              placeholder="0.00" 
              className="pl-8 h-11 rounded-lg border-gray-300 focus:border-black focus:ring-0 font-bold text-lg"
