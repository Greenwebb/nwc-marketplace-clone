    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-[#1D2128] mb-6 leading-tight">
            ...
            <Button className="bg-[#1D2128] hover:bg-[#11248F] text-white px-8 h-12">
              View Open Roles
            </Button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              ...
              <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-[#00BCD4]">
                <div className="absolute inset-0 flex items-center justify-center text-white text-6xl font-bold">
                  👩
                </div>
              </div>
            ...
            <div className="space-y-4 pt-8">
              <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-[#FFA726]">
                <div className="absolute inset-0 flex items-center justify-center text-white text-6xl font-bold">
                  👩
                </div>
              </div>
              <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-[#EF5350]">
                <div className="absolute inset-0 flex items-center justify-center text-white text-6xl font-bold">
                  👨
                </div>
              </div>
      ...
      <div className="bg-[#D4F1E8] py-16">
        <div className="container">
          <h2 className="text-3xl font-bold text-[#1D2128] text-center mb-4">
            Get to know us
          </h2>
      ...
      <div className="container py-20">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#1D2128] max-w-3xl mx-auto">
        ...
        <div className="space-y-16">
          {/* Value 1 */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-green-100 to-green-200">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#1D2128] mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-blue-100 to-blue-200 lg:order-2">
              <div className="absolute inset-0 flex items-center justify-center text-6xl">
                💼
              </div>
            </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-gray-200 to-gray-300 mb-4">
                <div className="absolute inset-0 flex items-center justify-center text-4xl">
                  🌴
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#1D2128] mb-2">Los Angeles</h3>
            ...
            {/* California */}
            <div className="text-center">
              <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-orange-200 to-orange-300 mb-4">
                <div className="absolute inset-0 flex items-center justify-center text-4xl">
                  ☀️
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#1D2128] mb-2">California</h3>
              <p className="text-sm text-[#7C818B]">
            ...
            {/* New York */}
            <div className="text-center">
              <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-blue-200 to-blue-300 mb-4">
                <div className="absolute inset-0 flex items-center justify-center text-4xl">
                  🗽
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#1D2128] mb-2">New York</h3>
              <p className="text-sm text-[#7C818B]">
      ...
      <div className="container py-20">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#1D2128] mb-8">
      ...
      <div className="container pb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Contact Us */}
          <div className="text-center p-8 border border-[#DADFE3] rounded-lg hover:shadow-lg transition-shadow">
            ...
            <h3 className="font-semibold text-[#1D2128] mb-2">
