                      ...
                      <div className="space-y-4">
                        {category.items.map((item, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className="border-2 border-[#A8E6CF] rounded-lg overflow-hidden"
                            >
                              <button
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link href="/help-center">
                <button className="bg-gray-900 text-white px-8 py-3 rounded-md text-base font-medium hover:bg-gray-800 transition-colors">
                  Help Center
                </button>
              </Link>
              <Link href="/contact">
                <button className="bg-white text-gray-900 px-8 py-3 rounded-md text-base font-medium hover:bg-gray-100 transition-colors border border-gray-300">
                  Contact Us
                </button>
              </Link>
            </div>
