          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-white rounded-lg shadow-lg p-2 mb-6">
              <div className="flex items-center gap-2">
                ...
                />
                <button className="bg-[#1E40AF] text-white p-3 rounded-md hover:bg-[#1E3A8A] transition-colors">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 text-sm">
              ...
              {popularSections.map((section, index) => (
                <span key={index}>
                  <Link href="#" className="text-gray-900 underline hover:text-[#1E40AF] transition-colors">
                    {section}
                  </Link>
            ...
            {faqCategories.map((category, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Link
                    href="#"
                    className="text-[#1E40AF] font-medium text-sm hover:underline inline-flex items-center gap-1"
                  >
                    View More
                    <span>→</span>
                  </Link>
      ...
      <section className="bg-gradient-to-br from-[#FFF9E6] to-[#FFF4D6] py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/contact">
              <button className="bg-gray-900 text-white px-8 py-4 rounded-md text-base font-medium hover:bg-gray-800 transition-colors">
                Contact Us
              </button>
            </Link>
          </div>
