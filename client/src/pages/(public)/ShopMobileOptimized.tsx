        ...
        <div className="pb-4 border-b border-[#DADFE3]">
          ...
          <div className="flex flex-wrap gap-2">
            {selectedCategories.map((cat) => (
              <span
                key={cat}
                className="inline-flex items-center gap-1 px-3 py-2 bg-[#ECF0F4] text-xs text-[#1D2128] rounded-full"
              >
                {cat}
              ...
              <div key={category.name} className="flex items-center justify-between min-h-[44px]">
                <div className="flex items-center gap-3">
                  <Checkbox
                    ...
                    className="w-5 h-5 border-[#DADFE3] data-[state=checked]:bg-[#11248F] data-[state=checked]:border-[#11248F]"
                  />
                  <Label
          ...
          <div className="space-y-3">
            {ratings.map((rating) => (
              <button
                ...
                className={`flex items-center gap-2 w-full min-h-[44px] px-3 py-2 rounded-lg transition-colors ${
                  selectedRating === rating.value ? "bg-[#ECF0F4]" : "hover:bg-[#F5F7FA]"
                }`}
              >
    ...
    <div className="min-h-screen flex flex-col bg-[#ECF0F4]">
        ...
        <div className="container py-4 lg:py-6">
          <div className="flex gap-6">
            ...
            <div className="flex-1">
              {/* Toolbar */}
              <div className="bg-white rounded-lg p-3 lg:p-4 mb-4 flex items-center justify-between gap-2 lg:gap-4">
                {/* Results Count */}
                ...
                <div className="hidden lg:flex items-center gap-1 border border-[#DADFE3] rounded-lg p-1">
                  <button
      ...
      <div className="fixed bottom-20 left-0 right-0 lg:hidden z-40 px-4">
        <button
          ...
          className="w-full bg-[#11248F] text-white rounded-full py-4 px-6 flex items-center justify-center gap-3 shadow-lg active:scale-95 transition-transform min-h-[56px]"
        >
        ...
        <DialogContent className="lg:hidden max-w-full h-[85vh] p-0 bottom-0 top-auto translate-y-0 data-[state=open]:slide-in-from-bottom data-[state=closed]:slide-out-to-bottom rounded-t-3xl">
          ...
          <div className="px-6 py-4 border-t border-[#DADFE3] bg-white">
            <Button
              ...
              className="w-full bg-[#11248F] text-white hover:bg-[#0D1A6F] rounded-full py-6 text-base font-medium"
            >
