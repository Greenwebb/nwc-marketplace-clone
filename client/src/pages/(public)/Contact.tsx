    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#F5F5F7] py-16">
        <div className="container">
          <h1 className="text-4xl md:text-5xl font-bold text-[#1D2128] text-center mb-4">
            We're here for you
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[#1D2128] mb-2">Customer Service</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[#1D2128] mb-2">Chat with us here!</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[#1D2128] mb-2">How can we help you today?</h3>
              <button className="text-[#11248F] font-medium mb-1 hover:underline">
                Help Center
              </button>
            </div>
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
          {/* Head Office */}
          <div>
            <h2 className="text-2xl font-bold text-[#1D2128] mb-6">Head Office</h2>
            <div className="space-y-3">
              <p className="text-[#1D2128]">
                345 Spear Street San Francisco, CA 94105
                <br />
                United States
              </p>
              <p className="text-[#1D2128]">+1 415-736-0000</p>
          ...
          {/* Store */}
          <div>
            <h2 className="text-2xl font-bold text-[#1D2128] mb-6">Store</h2>
            <div className="space-y-3">
              <p className="text-[#1D2128]">
          ...
          {/* Connect */}
          <div>
            <h2 className="text-2xl font-bold text-[#1D2128] mb-6">Connect</h2>
            <div className="space-y-3">
              <a href="#" className="flex items-center gap-2 text-[#1D2128] hover:text-[#11248F]">
      ...
      <div className="bg-[#D4F1E8] py-20">
        <div className="container max-w-2xl">
          <div className="text-center mb-8">
            <p className="text-sm text-[#1D2128] mb-2">Get in touch</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-2">
              ...
              />
              <label htmlFor="privacy" className="text-sm text-[#1D2128] cursor-pointer">
            ...
            <Button
              type="submit"
              className="w-full bg-[#1D2128] hover:bg-[#11248F] text-white h-12 text-base font-medium"
            >
              Get in Touch
            </Button>
          </form>
      ...
      <div className="container py-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex gap-4 max-w-md mx-auto">
            ...
            <Button
              type="submit"
              className="bg-[#1D2128] hover:bg-[#11248F] text-white px-8"
            >
              Subscribe
            </Button>
          </form>
