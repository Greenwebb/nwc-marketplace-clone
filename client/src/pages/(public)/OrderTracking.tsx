      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto">
            <form onSubmit={handleTrack} className="border-2 border-gray-200 rounded-lg p-8 md:p-10">
              <div className="space-y-6">
                {/* Order ID Field */}
                <div>
                  <Label htmlFor="orderId" className="text-base font-medium text-gray-900 mb-2 block">
                    Order ID
                  </Label>
                  <Input
                    id="orderId"
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-[#1E40AF] hover:bg-[#1E3A8A] text-white text-base font-medium"
                >
                  Track
                </Button>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-center text-center p-6">
                ...
                <a
                  ...
                  className="text-base font-medium text-[#1E40AF] hover:text-[#1E3A8A] transition-colors"
                >
                  1-866-237-8289
                </a>
              </div>
