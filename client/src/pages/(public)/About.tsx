    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-blue-100 to-blue-200">
      ...
      <div className="bg-[#FFF9E6] py-16">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1D2128] mb-4">
      ...
      <div className="container py-20">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#1D2128]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
          {partners.map((partner, index) => (
            <div
              key={index}
              className="flex items-center justify-center p-4 border border-[#DADFE3] rounded-lg hover:shadow-md transition-shadow"
            >
      ...
      <div className="bg-[#F5F5F7] py-20">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#1D2128] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1D2128] mb-2">Choose a Theme</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1D2128] mb-2">Add products</h3>
              <p className="text-[#7C818B]">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1D2128] mb-2">Start Selling</h3>
              <p className="text-[#7C818B]">
            ...
            {timeline.map((item, index) => (
              <div key={index} className="flex gap-6">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-full bg-[#11248F] flex items-center justify-center">
                    <Check className="h-6 w-6 text-white" />
                  </div>
                </div>
                <div className="flex-1">
                  <p className="text-sm text-[#11248F] font-semibold mb-1">{item.year}</p>
                  <h3 className="text-xl font-bold text-[#1D2128] mb-2">{item.title}</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <div key={index} className="text-center">
              ...
              <h3 className="font-bold text-[#1D2128] mb-1">{member.name}</h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
            {investors.map((investor, index) => (
              <div key={index} className="text-center">
                ...
                <h4 className="font-semibold text-[#1D2128] text-sm mb-1">{investor.name}</h4>
      ...
      <div className="container py-20">
        <div className="text-center max-w-2xl mx-auto">
          <p className="text-sm text-[#7C818B] mb-2">Purchase Motta</p>
