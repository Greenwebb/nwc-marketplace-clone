  ...
  return (
    <div className="min-h-screen bg-[#F4F6F8]">
      ...
      <main className="container py-8">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-[#DADFE3] mb-8">
          {/* Banner Image */}
          ...
          <div className="flex-1">
            ...
            <div className="bg-white p-4 rounded-lg border border-[#DADFE3] shadow-sm mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center border border-[#DADFE3] rounded-md overflow-hidden">
                  <button 
            ...
            <div className="mt-12 flex justify-center">
              <div className="flex items-center gap-2">
                ...
                <button className="px-4 h-10 rounded-md border border-[#DADFE3] bg-white text-[#1D2128] hover:border-[#11248F] hover:text-[#11248F] transition-colors font-medium flex items-center gap-1">
                  Next
